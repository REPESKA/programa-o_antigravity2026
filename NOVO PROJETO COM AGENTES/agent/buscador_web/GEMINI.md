...
No entanto, não crie nem sobrescreva diretivas sem autorização, a menos que isso tenha sido solicitado explicitamente. As diretivas são a base operacional do sistema e devem ser preservadas e aprimrotidas continuamente.
